# -*- coding: utf-8 -*-
"""
Created on Thu Mar 23 17:58:46 2023
...
#the type of food ordered by the customer and the type of vehicle used by the delivery partner affects the delivery time or 
fig = px.box(data, 
             x="Type_of_vehicle",
             y="Time_taken(min)", 
             color="Type_of_order")
